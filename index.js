...
let multiFloat = floatN * floatN2;
let divFloat = floatN / floatN2;

console.log(addFloat, subFloat, multiFloat, divFloat);

let number_1 = 10;
let string_1 = 'Hello';

let addNumAndString = string_1 + number_1 + 15;
let addNumAndString2 = number_1 + 15 + string_1;
let addNumAndString3 = number_1 + 15 + string_1;

console.log(addNumAndString);
console.log(addNumAndString2);
console.log(addNumAndString3);

let name = 'Aiza';
let age = 19;
let statement = `My name is ${name} and I am ${age} years old`;
let statement1 = `${number_1 + 15} ${string_1 +' '+'world'}`;
